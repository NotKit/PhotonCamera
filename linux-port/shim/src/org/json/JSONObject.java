...
/** A modifiable set of name/value mappings, as on ART's boot classpath. */
public class JSONObject {
	private static final Double NEGATIVE_ZERO = -0d;

	/** The sentinel a JSON null maps to; never equal to Java null. */
	...
	public JSONArray names() {
		return nameValuePairs.isEmpty() ? null
				: new JSONArray(new java.util.ArrayList<String>(nameValuePairs.keySet()));
	}
	...
	public static String numberToString(Number number) throws JSONException {
		...
		// the cast keeps -0.0 from printing as 0
	...
	static String numberToString(double value) throws JSONException {
		return numberToString(Double.valueOf(value));
	}

	public static String quote(String data) {
		if (data == null)
			return "\"\"";
		return new JSONStringer().quoted(data);
	}
