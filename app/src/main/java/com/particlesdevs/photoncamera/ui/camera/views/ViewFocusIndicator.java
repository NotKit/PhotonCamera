...
public class ViewFocusIndicator implements FocusIndicator {
    ...
    public void showFocusCircle(float x, float y) {
        ...
        focusCircle.animate().scaleY(1.2f).scaleX(1.2f)
                .setDuration(Motion.durationMedium1(focusCircle.getContext()))
                .setInterpolator(Motion.emphasized(focusCircle.getContext()))
                .withEndAction(() -> focusCircle.animate().scaleY(1f).scaleX(1f)
                        .setDuration(Motion.durationMedium1(focusCircle.getContext()))
                        .setInterpolator(Motion.emphasized(focusCircle.getContext())).start())
                .start();
    }
    ...
    public void hideFocusCircle() {
        ...
        focusCircle.animate().alpha(0f).scaleY(1.8f).scaleX(1.8f)
                .setDuration(Motion.durationShort2(focusCircle.getContext()))
                .setInterpolator(Motion.emphasizedDecelerate(focusCircle.getContext()))
                .withEndAction(() -> {
    ...
    @Override
    public boolean isOnFocusCircle(float x, float y) {
        return isInside(focusCircle, x, y);
    }
    ...
    public void showSpotWb(float x, float y) {
        ...
        spotWb.animate().scaleX(1.25f).scaleY(1.25f)
                .setDuration(Motion.durationShort3(spotWb.getContext()))
                .setInterpolator(Motion.emphasized(spotWb.getContext()))
                .withEndAction(() -> spotWb.animate().scaleX(1.0f).scaleY(1.0f)
                        .setDuration(Motion.durationShort3(spotWb.getContext()))
                        .setInterpolator(Motion.emphasized(spotWb.getContext())).start())
                .start();
    }
    ...
    public void hideSpotWb() {
        ...
        spotWb.animate().alpha(0f).scaleX(1.4f).scaleY(1.4f)
                .setDuration(Motion.durationShort2(spotWb.getContext()))
                .setInterpolator(Motion.emphasizedDecelerate(spotWb.getContext()))
                .withEndAction(() -> {
    ...
    @Override
    public boolean isOnSpotWb(float x, float y) {
        return isInside(spotWb, x, y);
    }

    /**
     * The indicators are placed with the same preview-relative coordinates a tap
     * arrives with, so a bounds test over the whole square view is exact.
     */
