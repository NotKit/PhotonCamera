...
class CameraScreenHost(private val context: Context) : CameraUIView {
    ...
    /** The shutter draws recording as not activated, which is what Unlimited and video set. */
    override fun setShutterRecording(recording: Boolean) = setShutterActivated(!recording)
