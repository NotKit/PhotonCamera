...
public interface PreviewSurface {
    ...
    /**
     * Holds the presented frame across a same-sensor (ISZ) lens switch until the
     * new stream settles; live rendering resumes on its own.
     */
    void beginPreviewSettleTracking();
