...
public interface FocusIndicator {
    ...
    /** True when (x, y) lands on the visible focus circle; a tap there cancels touch focus. */
    boolean isOnFocusCircle(float x, float y);
    ...
    /** True when (x, y) lands on the visible spot-WB reticle; a long press there cancels it. */
    boolean isOnSpotWb(float x, float y);
